    ...
    <div className="min-h-screen bg-gray-500 p-4 md:p-8 w-screen flex items-center justify-center">
        <div className="container mx-auto max-w-3xl bg-gray-600 rounded-lg shadow-lg p-6">
            ...
            <div className="mb-6">
                <p className="text-lg mb-4 bg-white p-4 rounded-lg shadow-md">{currentQuestion.QuestionTitle}</p>
                {options.map((option, index) => (
                    <div
                        key={index}
                        className={`bg-white p-4 rounded-lg cursor-pointer mb-4 transition duration-200 
                            ${selectedAnswers[currentQuestionIndex] === option ? 'text-green-300 bg-red-900' : 'hover:bg-lime-300'}
                        `}
            ...
            <div className="flex justify-between mb-4">
                <button
                    ...
                    className={`px-4 py-2 text-white rounded-md transition duration-300 
                        ${isFirstQuestion ? 'bg-gray-500 opacity-50 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'}
                    `}
                >
                    Previous
                </button>
                <button
                    ...
                    className={`px-4 py-2 text-white rounded-md transition duration-300 
                        ${isLastQuestion ? 'bg-gray-500 opacity-50 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'}
                    `}
                >
                    Next
                </button>
            ...
            <div className="flex justify-center mb-2">
                <button
                    ...
                    ref={submitButtonRef}
                    className="px-4 py-3 text-white bg-red-500 rounded-md shadow-md hover:bg-red-600 transition duration-300"
                >
                    Submit Test
                </button>
            </div>
