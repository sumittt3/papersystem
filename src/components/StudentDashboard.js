        ...
        <div className="min-h-screen w-screen bg-teal-700 flex flex-col">
                ...
                <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    <div className="hidden sm:flex gap-6">
                        <a
                            ...
                            className="text-white hover:text-gray-200 transition duration-300 text-lg font-bold flex items-center"
                        >
            ...
            <div className="flex flex-col gap-4 text-white p-4 pt-6">
                <div>
                    ...
                    <h2 className="text-lg sm:text-xl font-light pl-2">Your Email: {email}</h2>
                </div>

                <div className="w-full rounded-lg bg-gray-800 p-4">
                    <h2 className="text-2xl font-bold mb-4">Papers Available</h2>
                    {/* Placeholder for papers listing */}
