...
<div className="relative sm:hidden">
    ...
    {dropdownOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
            <a href={`/TeacherDashboard/${username}`} className="flex items-center block text-left px-4 py-2 text-gray-800 hover:bg-gray-700">
                Dashboard
            </a>
            <a href={`/Profile/${username}`} className="flex items-center block text-left px-4 py-2 text-gray-800 hover:bg-gray-700">
                Change Password
            </a>
            <a href={`/Test/${username}`} className="flex items-center block text-left px-4 py-2 text-gray-800 hover:bg-gray-700">
                Create Test
            </a>
            <button
