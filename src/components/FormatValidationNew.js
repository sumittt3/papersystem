    ...
    const handleValidation = () => {
      try {
        ...
        reader.onload = (e) => {
          ...
          const expectedHeaders = ['QuestionId', 'Question Title','Question Option', 'Difficulty Level', 'Subject',"Answer"];
...
export default FormatValidationNew;
