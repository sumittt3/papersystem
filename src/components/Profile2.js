...
const Profile2 = ({ setShowNavButtons }) => {
    ...
    return (
        <div className="min-h-screen w-screen bg-teal-800 flex flex-col">
            ...
            {isDropdownOpen && (
                <div className="md:hidden bg-gray-800 text-white shadow-md p-4">
                    <a href={`/StudentDashboard/${username}?email=${email}`} className="block py-2 hover:text-gray-200 transition duration-300">Dashboard</a>
                    <a href={`/Profile2/${username}?email=${email}`} className="block py-2 hover:text-gray-200 transition duration-300">Change Password</a>
                    <a href={`/TestCollection/${username}?email=${email}`} className="block py-2 hover:text-gray-200 transition duration-300">Test Collection</a>
                </div>
            )}
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <form onSubmit={handleChangePassword}>
                    ...
                    <button
                        type="submit"
                        className="inline-block bg-slate-900 hover:bg-blue-200 hover:text-black text-white font-bold py-2 px-4 rounded transition duration-300"
                    >
                        Change Password
                    </button>
                </form>
